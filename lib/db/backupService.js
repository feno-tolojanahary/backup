    ...
    async insert(backup) {
        try {
            ...
            const result = insert.run(
                backupUid, name, userId, encrypted, status, modifiedAt, storage, isSynced, lastSynced, storageConf, job_run_id, jobId
            )
        ...
        try {
            const stmt = db.prepare(`
                SELECT
                    ...
                    bf.storage AS storage,
                    bf.storage_conf AS storageConf
                FROM backups b
                LEFT JOIN backup_files bf ON b.id = bf.backup_id
