...
exports.sendToRemoteServers = async (fileName, { isDir = false } = {}) => {
...
exports.downloadDirFromServer = async (dirName, hostName) => {
    try {
        const hostConf = getHostConfig(hostName);
        
        const dstPath = path.join(config.workingDirectory, dirName);
        const remoteHost = new RemoteHost(hostConf);
        await remoteHost.connect();
