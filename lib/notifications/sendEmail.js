...
const { backupFailedTemplate } = require("./mailTemplate");
...
module.exports = sendEmailFailedBackup = async ({provider, backupInfo}) => {
    const template = backupFailedTemplate({ backupName: backupInfo.name, backupDate: backupInfo.date });
