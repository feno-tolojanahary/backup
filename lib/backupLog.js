...
const { entryExists } = require("./utils");
...
exports.removeLog = new BackupLog("removeLog.jsonl");
exports.failedLog = new BackupLog("failedLog.jsonl");