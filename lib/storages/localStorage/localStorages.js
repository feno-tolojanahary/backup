...
const { entryExists, getDirSize, verifyFolderWritable } = require("../../helper/utils");
...
class LocalStorage {
    ...
    async copyFolder(folderPath, dest = null, metaFiles = []) {
      ...
      return {
        ...
        type: "folder",
        destinationFolder: destDirPath,
        fullPath: path.join(destDirPath, path.basename(folderPath))
      }
    }
    ...
    async destFolderWritable() {
      return verifyFolderWritable(this.destDirPath());
    }
}
