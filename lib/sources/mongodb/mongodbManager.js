...
class MongodbManager {
    ...
    plainDumpMongoDb = async (outName = null) => {
        ...
        const outZip = path.join(this.config.workingDirectory, `${outName}.zip`);
        const filePath = path.join(this.config.workingDirectory, outName);
    ...
    restoreMongoDb = async (zipPath, dbName) => {
        ...
        const folderPath = path.join(dstFolderPath, dbName);
