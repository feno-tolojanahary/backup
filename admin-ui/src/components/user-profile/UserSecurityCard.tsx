...
type UserSecurityCardType = {
  onSubmit: (data: UserForm) => void
}

export default function UserSecurityCard({ onSubmit }: UserSecurityCardType) {
        ...
        <div className="relative w-full p-4 overflow-y-auto bg-white no-scrollbar rounded-3xl dark:bg-gray-900 lg:p-11">
          ...
          <form className="flex flex-col" onSubmit={handleSubmit(onSubmit)}>
            <div className="px-2 overflow-y-auto custom-scrollbar">
              <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                <div className="col-span-2 lg:col-span-1">
                  ...
                  <Input
                    ...
                    {...register("currentPassword", {
                      validate: (value) => {
                        const hasNewPassword = Boolean(getValues("newPassword"));
                ...
                <div className="col-span-2 lg:col-span-1">
                  ...
                  <Input
                    ...
                    {...register("newPassword", {
                      validate: (value) => {
                        if (!value) return true; // user isn't changing password
                  ...
                  <Input
                    ...
                    {...register("confirmPassword", {
                      validate: (value) => {
                        ...
                        if (!newPassword && value) return "Enter a new password first.";
                ...
                <div className="col-span-2 lg:col-span-1">
                  ...
                  <Input type="text" {...register("twoFactorSecret")} disabled />
                </div>

                <div className="col-span-2 lg:col-span-1">
                  <Label>Last Password Change</Label>
                  <Input type="text" {...register("lastPasswordChangeAt")} disabled />
                </div>
              </div>
            </div>
            <div className="flex items-center gap-3 px-2 mt-6 lg:justify-end">
              ...
              <Button size="sm" type="button" onClick={callOnSubmit}>
                Save Changes
              </Button>
            </div>
          </form>
