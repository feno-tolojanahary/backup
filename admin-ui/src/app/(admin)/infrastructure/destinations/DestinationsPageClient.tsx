...
const statusBadgeColor = (status: DestinationStatus) => {
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <Button
                ...
                variant="outline"
                type="button"
                onClick={() => console.log("Refresh destinations")}
              >
                Refresh
              </Button>
                    ...
                    >
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <div className="flex items-center gap-2">
                          <Badge
                            size="sm"
                            color={statusBadgeColor(destination.status)}
                          >
                            {destination.status}
                          </Badge>
                          <div className="relative">
                            ...
                            >
                              <DropdownItem
                                onItemClick={() => {
                                  setOpenMenuId(null);
                                  openTestConnection(destination);
                                }}
                      ...
                      <div className="mt-5 flex justify-end">
                        <Button
                          ...
                          variant="outline"
                          type="button"
                          onClick={() => openTestConnection(destination)}
                        >
                          Test connection
                        </Button>
                      </div>
      ...
      >
        <div className="p-6 sm:p-8">
          ...
          <div className="mt-4 rounded-xl border border-gray-200 bg-gray-50 p-4 text-sm text-gray-600 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-400">
            {selectedDestination?.lastTestStatus === "success" && (
              <p className="text-success-600">Connection successful.</p>
            )}
            {selectedDestination?.lastTestStatus === "failed" && (
              <>
                <p className="text-error-600">Connection failed.</p>
                {selectedDestination.lastTestMessage && (
            ...
            {selectedDestination?.lastTestStatus === "unknown" && (
